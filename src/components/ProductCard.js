...
export default function ProductCard({
  ...
  const handleCickIconHeart = async (e) => {
    ...
    if (!IconHeart) {
      console.log(
        "log check IconHeart khi trước đánh dấu thay đổi: ",
        IconHeart
      );
  ...
  return (
    <div className="product-card">
      ...
      <div className="product-actions">
        ...
        <button className="view-details-button" onClick={handleClickViewDetail}>
          Xem chi tiết
        </button>
      </div>
      ...
      <div className="product-actions-FaShoppingCart">
        {IconCart ? (
          <div className="left">
            <FaShoppingCart
              className="ShoppingCart-added"
              onClick={handleCickIconShoppingCart}
            />
          ...
          <div className="left">
            <FaShoppingCart
              className="ShoppingCart-non-added"
              onClick={handleCickIconShoppingCart}
            />
      ...
      <div className="product-actions-FaTshirt">
        {images?.length > 0 && images[0] ? (
          <div className="left">
            ...
            />
            <span>
              {loading ? "Đang kết hợp ảnh..." : "Thử đồ online nào!!!"}
            </span>
          </div>
        ) : (
      ...
      (
        <PortalModal open={showGuide} onClose={() => setShowGuide(false)}>
          <div>
            ...
            <ul>
              <li>
                Ảnh rõ nét, nên chỉ 1 người; nhìn thẳng, toàn thân càng tốt.
              </li>
              ...
              <li className="ai-note">
                Ảnh được tạo bởi AI, kết quả có thể không hoàn hảo và chính xác
                như mong muốn!
              </li>
            </ul>
            <div className="tryon-guide-actions">
              ...
              <button className="btn-primary" onClick={handleContinueFromGuide}>
                Tiếp tục chọn ảnh
              </button>
            </div>
          </div>
        ...
        <PortalModal open={showConfirm} onClick={() => setshowConfirm(false)}>
          <div className="confirm-box">
            <p>Hãy đọc hướng dẫn trước khi thử tính năng nhé!</p>
            <div className="actions">
              <button
                className="btn-confirm"
                onClick={handleCickConfirmAuthenticator}
              >
                Có
              </button>
              <button
      ...
      <PortalModal open={showResult} onClose={() => setShowResult(false)}>
        <div className="tryon-result-modal">
          ...
          <line className="ai-note">
            Ảnh được tạo bởi AI, kết quả có thể không hoàn hảo và chính xác như
            mong muốn!
          </line>
          <div className="tryon-guide-actions">
            <button
            ...
            {resultUrl && (
              <>
                <a
                  ...
                  href={`${server}/download/tryon/${resultUrl
                    .split("/")
                    .pop()}`} // ví dụ http://localhost:8080/download/tryon/combine-....png
                >
                  {" "}
                  Tải xuống
                </a>
      ...
      <PortalModal open={removeProduct} onClose={() => setRemoveProduct(false)}>
        <div className="confirm-box">
          ...
          <div className="actions">
            <button
              className="btn-confirm"
              onClick={handleCickConfirmRemoveProduct}
            >
              Có
            </button>
            <button
